...
const actions = [
  ...
  'EXPORT_EDIT', 'EXPORT_EDIT_SUCCEED', 'EXPORT_EDIT_FAIL',
...
export function submit(exportaccept, params) {
  return {
    [CLIENT_API]: {
...
export function loadForm(cookie, idId) {
  return loadFormC(cookie, 'v1/export/exportaccept', {
    pid: idId
  }, actionTypes);
}
...
export function edit(exportaccept, params) {
  return {
    [CLIENT_API]: {
      types: [actionTypes.EXPORT_EDIT, actionTypes.EXPORT_EDIT_SUCCEED, actionTypes.EXPORT_EDIT_FAIL],
      endpoint: 'v1/export/exportaccept',
      method: 'put',
      data: {
        exportaccept,
...
export function invalidAccept(params) {
  return {
    [CLIENT_API]: {
      ...
      endpoint: 'v1/export/invalidAccept',
      method: 'put',
      params
    }
  };
...
export function loadLogs(params) {
  return {
    [CLIENT_API]: {
      ...
      endpoint: 'v1/export/exportacceptlogs',
      method: 'get',
      params
    }
  };
