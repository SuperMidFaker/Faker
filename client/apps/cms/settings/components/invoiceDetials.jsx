        ...
        <Card style={{ margin: 16 }}>
          <div className="page-header">
            ...
            <Row gutter={16}>
              ...
              <Col sm={12}>
                <InfoItem label="发票日期  Invoice Date" field={invoice.invoice_date} editable placeholder="输入发票日期" dataIndex="invoice_date" onEdit={this.handleFill} />
              </Col>
              <Col sm={12}>
                <InfoItem label="买方  Buyer" field={invoice.buyer} editable placeholder="输入买方" dataIndex="buyer" onEdit={this.handleFill} />
              </Col>
              <Col sm={12}>
                {!!invoice.industry_en && <InfoItem label="行业分类  IC" field={invoice.ic} editable placeholder="输入行业分类" dataIndex="ic" onEdit={this.handleFill} />}
              </Col>
            </Row>
            <span />
