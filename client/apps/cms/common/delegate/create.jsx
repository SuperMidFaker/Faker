...
import { createDelegationByCUS } from 'common/reducers/cmsDelegation';
...
export default class AcceptanceCreate extends Component {
  static propTypes = {
    ...
    createDelegationByCUS: PropTypes.func.isRequired,
  }
  static contextTypes = {
  ...
  handleSave = () => {
    this.props.form.validateFields(errors => {
      if (!errors) {
        ...
        this.props.createDelegationByCUS({
