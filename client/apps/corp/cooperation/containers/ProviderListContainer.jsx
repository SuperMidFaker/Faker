...
import { setProviderType, editProviderTypes, editProviderTypesLocal, addPartner, editPartner, changePartnerStatus } from 'common/reducers/partner';
...
@connect(state => ({
  ...
  addPartner, editPartner, changePartnerStatus,
})
