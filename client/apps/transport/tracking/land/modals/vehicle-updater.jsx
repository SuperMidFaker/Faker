...
import { closeVehicleModal, saveVehicle } from 'common/reducers/landStatus';
...
@connect(
  state => ({
    visible: state.landStatus.vehicleModal.visible,
    dispId: state.landStatus.vehicleModal.dispId,
  }),
