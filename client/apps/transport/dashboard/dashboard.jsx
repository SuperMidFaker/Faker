          ...
          <Row gutter={16}>
            ...
            <Col sm={24} md={6}>
              <Card title="更多应用" bodyStyle={{ minHeight: 400, textAlign: 'center' }} >
                ...
                <br />
                <Row><Input value={this.state.shipmtNo} onChange={e => this.setState({ shipmtNo: e.target.value })} /></Row>
                <br />
                <Row><Button type="primary" onClick={this.handleQuery}>查询</Button> <Button style={{ marginLeft: 20 }}>共享</Button></Row>
                <br />
                ...
                <Row className="mdc-text-grey">
                  <img style={{ width: 50, height: 'auto' }} role="presentation" src={`${__CDN__}/assets/img/apple.png`} />
                  <img style={{ width: 50, height: 'auto', marginLeft: 40 }} role="presentation" src={`${__CDN__}/assets/img/android.png`} />
                </Row>
                <br />
                <Row><Button onClick={() => window.open('https://fir.im/welogixApp')}>直接下载</Button> <Button onClick={() => window.open('https://fir.im/welogixios')} style={{ marginLeft: 40 }}>直接下载</Button></Row>
                <br />
                <Row style={{ borderTop: 'solid 1px #e9e9e9' }} />
                <br />
