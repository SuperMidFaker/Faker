...
import { closeMovementModal, loadProductInboundDetail, loadAllocatedDetails, manualAlloc } from 'common/reducers/cwmOutbound';
...
@connect(
  ...
  { closeMovementModal, loadProductInboundDetail, loadAllocatedDetails, manualAlloc }
)
