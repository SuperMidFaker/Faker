...
import { updateSingleWindowApp } from 'common/reducers/openIntegration';
...
@connect(
  state => ({
    app: state.openIntegration.singleWindowApp,
  }),
  { updateSingleWindowApp }
)
@Form.create()
export default class ParamsForm extends Component {
  ...
  handleSave = () => {
    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        this.props.updateSingleWindowApp({ ...values, uuid: app.uuid }).then((result) => {
          if (result.error) {
