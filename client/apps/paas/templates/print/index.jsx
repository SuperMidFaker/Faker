...
export default class PrintTemplateList extends React.Component {
  static propTypes = {
  ...
  render() {
    ...
    return (
      <Layout>
        <HubSiderMenu currentKey="printTempl" openKey="templates" />
        <Layout>
          <PageHeader title={this.msg('printTempl')}>
            <PageHeader.Actions>
