...
console.log(dividGrossWt(bodyDatas.slice(0, bodyDatas.length - 1).map(bd => bd.wet_wt || 0), totGrossWt));
...
console.log(dividAmount(bodyDatas.map(bd => bd.trade_total), amount));
